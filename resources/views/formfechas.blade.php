            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="date" class="date-input" name="etapa1_periodo1"></td>
                        <td><input type="date" class="date-input" name="etapa1_periodo2"></td>
                        <td><input type="date" class="date-input" name="etapa1_periodo3"></td>
                    </tr>
                    <tr>
                        <td class="etapa-label">
                        ...
                        <td><input type="date" class="date-input" name="etapa2_periodo1"></td>
                        <td><input type="date" class="date-input" name="etapa2_periodo2"></td>
                        <td><input type="date" class="date-input" name="etapa2_periodo3"></td>
                    </tr>
                    <tr>
                        <td class="etapa-label">
                        ...
                        <td><input type="date" class="date-input" name="etapa3_periodo1"></td>
                        <td><input type="date" class="date-input" name="etapa3_periodo2"></td>
                        <td><input type="date" class="date-input" name="etapa3_periodo3"></td>
                    </tr>
                    <tr>
                        <td class="etapa-label">
                        ...
                        <td><input type="date" class="date-input" name="etapa4_periodo1"></td>
                        <td><input type="date" class="date-input" name="etapa4_periodo2"></td>
                        <td><input type="date" class="date-input" name="etapa4_periodo3"></td>
                    </tr>
                    <tr>
                        <td class="etapa-label">
                        ...
                        <td><input type="date" class="date-input" name="etapa5_periodo1"></td>
                        <td><input type="date" class="date-input" name="etapa5_periodo2"></td>
                        <td><input type="date" class="date-input" name="etapa5_periodo3"></td>
                    </tr>
                </tbody>
            </table>
